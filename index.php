		...
		<?php if ( is_home() ) : ?>
			<div class="blog-main-container">
				...
				<div class="il_block il_section hp-helping-donate-now-section " style=" --b-space-top-ld: 6.5rem; --b-space-bottom-ld: 8.1rem; --b-space-top-mt: 10rem; --b-space-bottom-mt: 32rem;">
					...
					<img width="670" height="360" src="/wp-content/uploads/2023/10/Image-18.png" class="bg_element" alt="" decoding="async" style="--bg-e-width-lg: auto; --bg-e-height-lg: 100%; --bg-e-left-lg: auto; --bg-e-right-lg: 0; --bg-e-top-lg: 0; --bg-e-bottom-lg: 0; --bg-e-width-mt: 33.5rem; --bg-e-height-mt: 18rem; --bg-e-left-mt: 0; --bg-e-right-mt: 0; --bg-e-top-mt: 0; --bg-e-bottom-mt: 0; --bg-e-display-mobile: none" srcset="/wp-content/uploads/2023/10/Image-18.png 670w, /wp-content/uploads/2023/10/Image-18-300x161.png 300w" sizes="(max-width: 670px) 100vw, 670px"><img width="611" height="536" src="/wp-content/uploads/2023/10/Donate-now_image_mobile-1.png" class="bg_element" alt="" decoding="async" style="--bg-e-width-lg: 61.1rem; --bg-e-height-lg: 53.6rem; --bg-e-left-lg: 0; --bg-e-right-lg: 0; --bg-e-top-lg: 0; --bg-e-bottom-lg: 0; --bg-e-width-mt: 40rem; --bg-e-height-mt: auto; --bg-e-left-mt: auto; --bg-e-right-mt: 0; --bg-e-top-mt: auto; --bg-e-bottom-mt: 0; --bg-e-display-desktop: none" srcset="/wp-content/uploads/2023/10/Donate-now_image_mobile-1.png 611w, /wp-content/uploads/2023/10/Donate-now_image_mobile-1-300x263.png 300w" sizes="(max-width: 611px) 100vw, 611px">
					</div>
